...
import P2pConfigWidget from './P2pConfig';
          ...
          <div ref={dialogRef}
            ...
            <div id='user-settings-content' className="flex flex-1">
              <div className="border-r border-gray-200 flex flex-col">
                ...
                <div
                  className={`cursor-pointer p-4 flex items-center ${activeTab === Tab.P2P_TAB ? 'bg-gray-200 dark:bg-gray-700' : ''}`}
                  onClick={() => setActiveTab(Tab.P2P_TAB)}>
                  <GlobeAltIcon className="w-4 h-4 mr-3" aria-hidden="true" />P2p Network
                </div>
              </div>
              <div className="flex-1 p-4 flex flex-col">
                ...
                <div className={`${activeTab === Tab.P2P_TAB ? 'flex flex-col flex-1' : 'hidden'}`}>
                  <P2pConfigWidget />
                </div>
              </div>
            </div>
