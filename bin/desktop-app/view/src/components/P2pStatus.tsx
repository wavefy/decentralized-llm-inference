    ...
    return (
        <div className="bg-gray-800 p-3 rounded-lg text-sm text-gray-300 border border-gray-700 mb-4">
            ...
            <div className="space-y-1">
                <StatusItem label="Balance" value={p2pStatus?.balance || '...'} />
                <StatusItem label="Earning" value={p2pStatus?.earning || '...'} />
                <StatusItem label="Spending" value={p2pStatus?.spending || '...'} />
                <StatusItem label="Peers" value={p2pStatus?.peers || '...'} />
                <StatusItem label="Sessions" value={p2pStatus?.sessions || '...'} />
